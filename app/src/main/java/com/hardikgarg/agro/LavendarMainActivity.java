...
public class LavendarMainActivity extends AppCompatActivity {
    Button b;
    TextView t1;
    int d;
    int y;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lavendar_main);
...
//        b = findViewById(R.id.idChangeCrop);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(crop.equals("none")){
                    Dialog dialog=new Dialog(LavendarMainActivity.this);
                    ...
                    btnOkay.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            Intent intent = new Intent(LavendarMainActivity.this,CropChoose.class);
                            intent.putExtra("state",stateFromDb);
                            startActivity(intent);
                            dialog.dismiss();
                        }
                    ...
                    btnOkay.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            DatePickerDialog g=new DatePickerDialog(LavendarMainActivity.this, new DatePickerDialog.OnDateSetListener() {
                                @Override
