...
public class LettuceMainActivity extends AppCompatActivity {
    Button b;
    TextView t1;
    int d;
    int y;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lettuce_main);
...
//        b = findViewById(R.id.idChangeCrop);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(crop.equals("none")){
                    Dialog dialog=new Dialog(LettuceMainActivity.this);
                    ...
                    btnOkay.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            Intent intent = new Intent(LettuceMainActivity.this,CropChoose.class);
                            intent.putExtra("state",stateFromDb);
                            startActivity(intent);
                            dialog.dismiss();
                        }
                    ...
                    btnOkay.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            DatePickerDialog g=new DatePickerDialog(LettuceMainActivity.this, new DatePickerDialog.OnDateSetListener() {
                                @Override
