...
//        b = findViewById(R.id.idChangeCrop);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(crop.equals("none")){
                    Dialog dialog=new Dialog(TeaMainActivity.this);
                    ...
                    btnOkay.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            Intent intent = new Intent(TeaMainActivity.this,CropChoose.class);
                            intent.putExtra("state",stateFromDb);
                            startActivity(intent);
                            dialog.dismiss();
                        }
                    ...
                    btnOkay.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            DatePickerDialog g=new DatePickerDialog(TeaMainActivity.this, new DatePickerDialog.OnDateSetListener() {
                                @Override
