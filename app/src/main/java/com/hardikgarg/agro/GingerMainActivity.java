...
public class GingerMainActivity extends AppCompatActivity {
    Button b;
    TextView t1;
    int d;
    int y;
...
//        b = findViewById(R.id.idChangeCrop);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(crop.equals("none")){
                    Dialog dialog=new Dialog(GingerMainActivity.this);
                    ...
                    btnOkay.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            Intent intent = new Intent(GingerMainActivity.this,CropChoose.class);
                            intent.putExtra("state",stateFromDb);
                            startActivity(intent);
                            dialog.dismiss();
                        }
                    ...
                    btnOkay.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            DatePickerDialog g=new DatePickerDialog(GingerMainActivity.this, new DatePickerDialog.OnDateSetListener() {
                                @Override
